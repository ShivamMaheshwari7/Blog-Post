...
connection.close();
pw.print(gson.toJson(new BlogPostError("USER_NOT_FOUND")));
pw.flush();
return;
}
...
preparedStatement.close();
connection.close();
if(password.equalsIgnoreCase(dbPassword)==false)
{
pw.print(gson.toJson(new BlogPostError("PASSWORD_NOT_MATCH")));
pw.flush();
return;
}
